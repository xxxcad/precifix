...
import { createUser } from "@/app/configuracoes/usuarios/actions";
  ...
  return <>
    ...
    <section className="wide-card form-card">
      ...
      <form action={createUser} className="entity-form form-grid">
        ...
        <div className="form-actions full"><Link className="secondary-button" href="/">Voltar</Link><button className="primary-button" type="submit">Criar usuário</button></div>
      </form>
    </section>
