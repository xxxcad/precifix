...
export default async function Page() {
  ...
  const [{ data: rules }, { data: profile }] = await Promise.all([
    supabase.from("fiscal_rules").select("*").order("name"),
