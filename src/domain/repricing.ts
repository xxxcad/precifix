...
export function repricingTypeLabel(sourceType: string): RepricingTypeLabel {
  ...
  if (["PRODUCT_MARKETPLACE_COMMISSION_CHANGE", "PRODUCT_MARKETPLACE_FIXED_FEE_CHANGE", "PRODUCT_MARKETPLACE_LISTING_CHANGE", "PRODUCT_MARKETPLACE_CHANGE", "MARKETPLACE_CHANGE", "MARKETPLACE_FEE_BAND_CHANGE", "MARKETPLACE_FEE_RULE_CHANGE"].includes(sourceType)) return "Comissão/Tarifa";
  ...
  if (sourceType === "PRODUCT_CHANGE") return "Cadastro/Status";
  return "Outros";
}
