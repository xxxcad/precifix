  ...
  function savePricing() {
    ...
    startSaving(async () => {
      ...
      const outcome = manualMode ? await saveManualPricingSnapshot({ ...simulation, manualProduct: {
        productName: manualProductName, fiscalRuleId: manualRuleId, cost: manualProduct.cost, stAmount: manualProduct.stAmount,
    ...
    <div className="pricing-grid">
      <section className="pricing-input-panel">
        ...
        {!manualMode ? <div className="search-combobox">
          ...
          <label className="manual-product-name"><span>Nome do produto</span><input aria-label="Nome do produto manual" value={manualProductName} maxLength={160} onChange={(event) => setManualProductName(event.target.value)} placeholder="Ex.: Produto para simulação" /></label>
